                  ...
                  <>
                    ...
                    <div className="absolute left-0 mt-2 w-72 card-neumorphic p-2 z-50 animate-fade-in max-h-[70vh] overflow-y-auto">
                      ...
                      <button onClick={() => { setCurrentView('board-reports'); setShowProMenu(false); }} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[var(--background)] transition-colors text-left">
                        ...
                        <div><div className="font-medium text-sm">Portfolio Snapshot</div><div className="text-xs text-[var(--foreground-muted)]">Professional reports</div></div>
                      </button>
  ...
  const generateExecutiveReport = () => {
    ...
    return `
      ...
      <body>
        ...
        <div class="narrative">
          <p>The analysis of our current portfolio performance reveals several critical areas requiring immediate attention within the next 30-90 days. First and foremost, we must address the ${atRiskCount} facilities currently operating at 1-2 star ratings. These facilities represent not only a reputational risk but also significant financial exposure through potential Medicare Advantage network exclusions and reduced referral volumes. We recommend deploying dedicated rapid-response improvement teams to each at-risk facility, with authority to make immediate operational changes and access to emergency staffing resources.</p>

          <p>Staffing represents our most urgent challenge across the portfolio. With the CMS minimum staffing rule implementation approaching, we must immediately audit all facilities against the 3.48 total nursing HPRD and 0.55 RN HPRD thresholds. Facilities falling below these benchmarks require immediate recruitment initiatives, including sign-on bonuses, enhanced shift differentials for hard-to-fill positions, and partnerships with local nursing schools for pipeline development. Weekend staffing consistency—a key metric in CMS's staffing rating methodology—must be addressed through revised scheduling protocols and weekend premium pay structures.</p>

          <p>Health inspection preparedness demands immediate focus, particularly for facilities with survey anniversaries approaching within the next 90 days. We recommend conducting mock surveys at all facilities rated 3 stars or below, with emphasis on infection control protocols, medication management, and resident rights compliance. Any facilities with outstanding plans of correction must demonstrate sustained compliance before their next survey cycle. The immediate implementation of daily clinical rounds by the Director of Nursing, weekly quality assurance meetings, and real-time incident reporting systems will strengthen our survey readiness posture.</p>

          <p>Additionally, we must immediately address any facilities with Special Focus Facility candidacy indicators. These facilities should receive priority attention from regional clinical leadership, enhanced corporate oversight, and dedicated quality improvement resources. The reputational and financial consequences of SFF designation—including mandatory disclosure requirements and increased survey frequency—make prevention of this designation a critical immediate priority.</p>
        </div>

        <h2>Long-Term Recommendations</h2>
        <div class="narrative">
          <p>Looking beyond immediate tactical interventions, our portfolio requires strategic long-term investments to achieve sustained quality excellence and competitive positioning in an evolving regulatory and market environment. The skilled nursing industry is experiencing fundamental transformation through value-based purchasing expansion, Medicare Advantage growth, and increasing consumer quality awareness. Our long-term strategy must position the portfolio to thrive in this new landscape while building organizational capabilities that create sustainable competitive advantages.</p>

          <p>Workforce development represents our most critical long-term strategic imperative. The national nursing shortage shows no signs of abatement, and facilities that cannot attract and retain quality staff will inevitably see quality metrics decline. We recommend establishing a comprehensive workforce development program including: tuition reimbursement and loan forgiveness programs for CNAs pursuing nursing degrees, career ladder programs that promote from within, mentorship programs pairing experienced nurses with new graduates, and competitive compensation packages benchmarked against market rates annually. Investment in staff technology tools—including mobile documentation systems and real-time resident monitoring—will both improve care delivery and enhance job satisfaction.</p>

          <p>Technology infrastructure modernization should be prioritized across the portfolio. Facilities utilizing advanced electronic health records, predictive analytics for fall and pressure injury prevention, and automated compliance monitoring consistently outperform peers on quality metrics. We recommend a phased technology investment program targeting standardized EHR platforms, integrated PBJ reporting systems, and real-time quality dashboards accessible to facility and corporate leadership. These investments typically yield returns within 18-24 months through improved ratings, reduced survey deficiencies, and enhanced operational efficiency.</p>

          <p>Finally, our long-term strategy should include deliberate portfolio composition management. We should evaluate underperforming facilities for potential divestiture or operational restructuring while identifying acquisition opportunities in markets where we can leverage regional density for shared services and clinical expertise. A target portfolio composition of 60% facilities rated 4-5 stars, with no facilities below 3 stars, should guide strategic capital allocation decisions over the next 3-5 years.</p>
        </div>

        <h2>Opportunities Identified</h2>
        <div class="narrative">
          <p>Our portfolio analysis reveals several significant opportunities that, if executed effectively, could meaningfully improve both quality performance and financial returns. The most immediate opportunity lies in the Medicare Advantage preferred provider network strategy. Facilities rated 4-5 stars command substantial advantages in MA contracting, including higher reimbursement rates, priority referral status, and reduced administrative burden. With ${highPerformers} facilities currently at 4-5 stars, we have a strong foundation to pursue aggressive MA network positioning in those markets while implementing targeted improvement programs to elevate additional facilities into preferred network eligibility.</p>

          <p>The anticipated CMS staffing rule implementation creates a unique competitive opportunity. While many operators view the new requirements purely as a compliance burden, facilities that proactively achieve and exceed these standards will gain differentiation in markets where competitors struggle with compliance. We should position our compliant facilities as employer-of-choice destinations for nurses seeking stable, well-staffed work environments, potentially capturing market share in recruitment while competitors face staffing crises. This first-mover advantage in staffing compliance could yield sustained benefits in quality performance and market positioning.</p>

          <p>Quality measure improvement programs present significant rating uplift potential with relatively modest investment. Analysis of our portfolio indicates several facilities where targeted interventions on specific measures could yield meaningful overall rating improvements. For example, facilities with elevated antipsychotic medication rates (above 15%) that implement comprehensive behavioral intervention programs typically see one-star improvements in QM ratings within 6-9 months. Similarly, facilities with pressure ulcer rates above state averages can achieve rapid improvement through enhanced prevention protocols, specialized wound care training, and appropriate support surface investments.</p>

          <p>Regional market consolidation opportunities merit strategic evaluation. In markets where we operate multiple facilities, shared services arrangements—including centralized staffing pools, joint purchasing cooperatives, and regional clinical leadership—can improve both quality and financial performance. Additionally, several markets present acquisition opportunities where distressed competitors may become available, allowing portfolio expansion with properties that benefit from our operational infrastructure and quality improvement expertise.</p>
        </div>

        <h2>What We Have Going Right</h2>
        <div class="narrative">
          <p>While this report appropriately focuses on improvement opportunities and risk mitigation, it is equally important to recognize the substantial strengths and achievements across our portfolio that provide the foundation for continued success. Our ${fiveStarCount} five-star facilities represent exceptional care delivery and operational excellence, demonstrating that our organization possesses the capabilities, culture, and commitment necessary to achieve the highest quality standards. These facilities serve as centers of excellence and provide best practice templates that can be replicated across the portfolio.</p>

          <p>Our portfolio average rating of ${avgRating} stars positions us ${parseFloat(avgRating) >= 3.0 ? 'above' : 'at'} the national average, reflecting the dedication of thousands of caregivers across our facilities who deliver compassionate, skilled care to residents and families every day. The ${highPerformers} facilities (${((highPerformers/totalFacilities)*100).toFixed(0)}% of our portfolio) rated 4-5 stars demonstrate consistent execution of quality care protocols, effective staffing management, and strong survey performance. This substantial base of high-performing facilities provides financial stability through premium market positioning and serves as proof of concept for our improvement methodologies.</p>

          <p>Our organizational infrastructure—including regional clinical leadership, corporate quality improvement resources, and standardized operational protocols—provides capabilities that smaller operators cannot match. This infrastructure enables rapid deployment of improvement interventions, consistent policy implementation, and knowledge sharing across facilities. The investments we have made in training programs, compliance systems, and operational technology create sustainable advantages that compound over time. Our data analytics capabilities, exemplified by this reporting system, enable evidence-based decision-making and proactive management that distinguishes our approach from competitors relying on reactive, intuition-based management.</p>

          <p>Perhaps most importantly, our organization has demonstrated resilience and adaptability through recent industry challenges including the COVID-19 pandemic, workforce shortages, and regulatory changes. Facilities that weathered these challenges while maintaining quality standards have proven their operational strength and leadership capabilities. This organizational resilience, combined with our commitment to continuous improvement and our substantial portfolio of high-performing facilities, positions us well for continued success as the industry evolves.</p>
        </div>
  ...
  const generateDetailedReport = () => {
    ...
    return `
      ...
      <body>
        ...
        <h2>Immediate Recommendations</h2>
        <div class="narrative">
          <p>Based on our detailed facility-by-facility analysis, several immediate actions are required to address performance gaps and mitigate operational risks. The data clearly indicates that staffing consistency represents the most prevalent challenge across underperforming facilities. Facilities with staffing ratings of 2 stars or below require immediate scheduling audits to identify coverage gaps, particularly during weekend shifts where CMS applies specific scrutiny. We recommend implementing centralized staffing coordinators at regional level to facilitate cross-facility staff sharing during census fluctuations and unexpected absences.</p>

          <p>Health inspection performance demands immediate attention at facilities approaching their survey anniversary dates. The data shows that facilities with health inspection ratings below 3 stars typically exhibit patterns of recurring deficiencies in specific regulatory areas. We recommend immediate implementation of targeted mock surveys focusing on the F-tags most commonly cited in previous surveys. These mock surveys should be conducted by regional clinical consultants rather than facility staff to ensure objective assessment and identification of blind spots in current practices. Any deficiencies identified must trigger immediate corrective action plans with documented follow-up within 48 hours.</p>

          <p>Quality measure performance offers opportunities for rapid improvement at several facilities where specific measures are driving down composite scores. Analysis of individual facility QM profiles reveals that antipsychotic medication usage, pressure ulcer incidence, and urinary tract infection rates represent the most common improvement opportunities. Facilities with QM ratings below 3 stars should immediately implement enhanced monitoring protocols for these specific measures, including daily clinical huddles focused on at-risk residents, weekly trending reviews, and root cause analysis for any adverse events. Behavioral intervention programs for residents currently receiving antipsychotic medications should be prioritized, as reductions in this measure can yield meaningful rating improvements within two quarters.</p>

          <p>Administrative compliance systems require immediate assessment at facilities with documentation deficiencies. Accurate and timely MDS submissions, proper PBJ data entry, and comprehensive care planning documentation directly impact both quality measures and survey outcomes. We recommend immediate system audits at underperforming facilities to identify data integrity issues and implement corrective workflows.</p>
        </div>

        <h2>Long-Term Recommendations</h2>
        <div class="narrative">
          <p>The detailed analysis of our portfolio reveals strategic opportunities that require sustained, multi-year commitments to fully realize. First, workforce development must become a cornerstone of our long-term operational strategy. The skilled nursing industry faces structural labor shortages that will intensify over the coming decade as demographic trends increase demand while the healthcare workforce supply remains constrained. Facilities that establish themselves as employers of choice through competitive compensation, robust benefits, professional development opportunities, and positive workplace cultures will secure sustainable competitive advantages in quality delivery.</p>

          <p>We recommend establishing a comprehensive nursing career development program across the portfolio. This program should include tuition assistance for CNAs pursuing LPN certification, LPNs pursuing RN degrees, and RNs pursuing advanced degrees or specialty certifications. Such investments typically yield returns through reduced turnover costs, improved care quality, and enhanced recruitment capability. Additionally, nurse residency programs that provide structured support during the first year of employment can significantly reduce costly early-career turnover while building organizational loyalty and clinical competency.</p>

          <p>Technology infrastructure investments should be prioritized to support both operational efficiency and quality improvement. Advanced electronic health record systems with integrated clinical decision support can reduce medication errors, improve care coordination, and generate real-time quality monitoring capabilities. Predictive analytics tools that identify residents at elevated risk for falls, pressure injuries, or hospitalizations enable proactive intervention rather than reactive care. While these investments require significant capital, facilities with modern technology infrastructure consistently outperform peers on quality metrics while achieving operational efficiencies that improve financial performance over time.</p>

          <p>Strategic portfolio management should guide long-term capital allocation decisions. Facilities that consistently underperform despite improvement investments may warrant consideration for divestiture, while market opportunities for acquisitions should be evaluated based on potential quality uplift through application of our operational capabilities. A deliberate approach to portfolio composition that prioritizes quality-capable facilities in favorable market positions will strengthen our competitive standing over the long term.</p>
        </div>

        <h2>Opportunities Identified</h2>
        <div class="narrative">
          <p>Our detailed portfolio analysis has identified several significant opportunities for performance improvement and competitive advancement that merit strategic focus. The most compelling opportunity involves leveraging our high-performing facilities—those rated 4-5 stars—as centers of excellence that can share best practices, provide mentorship to struggling facilities, and serve as training sites for staff development programs. These facilities have demonstrated mastery of the operational practices that drive quality ratings; systematically documenting and disseminating their approaches can accelerate improvement across the portfolio.</p>

          <p>Market positioning opportunities exist in regions where we maintain multiple facilities. In these markets, we can implement regional care coordination programs that optimize patient placement based on clinical needs, facilitate smooth transitions between facilities as care requirements change, and present unified marketing presence to referral sources and payer networks. Regional density also enables shared staffing pools that can provide coverage flexibility while ensuring staff familiarity with organizational policies and procedures—a significant quality and efficiency advantage over ad-hoc agency staffing arrangements.</p>

          <p>Several individual facilities present specific improvement opportunities based on their rating component profiles. Facilities with strong health inspection and quality measure ratings but lower staffing ratings may achieve meaningful overall rating improvements through focused staffing optimization—potentially the most efficient path to rating enhancement. Conversely, facilities with adequate staffing but lower health inspection ratings may benefit from enhanced survey preparation programs and compliance system investments. This analysis-driven approach to improvement resource allocation can maximize rating improvements per dollar invested.</p>

          <p>Payer contracting opportunities align with our quality improvement strategy. As Medicare Advantage continues to capture market share and commercial payers increasingly incorporate quality metrics into contracting decisions, facilities with strong Five-Star ratings command premium positioning. Targeted improvement investments that elevate facilities to 4-5 star status can unlock substantial revenue enhancements through improved payer contracts, increased referral volumes, and higher private-pay census conversion rates. The financial returns from quality improvement often exceed the investment required to achieve those improvements.</p>
        </div>

        <h2>What We Have Going Right</h2>
        <div class="narrative">
          <p>This detailed analysis reveals substantial organizational strengths that provide the foundation for continued quality improvement and operational excellence. Across our ${totalFacilities} facilities, we have assembled teams of dedicated healthcare professionals who deliver compassionate, skilled care to thousands of residents and families. The complexity of skilled nursing operations—managing clinical care, regulatory compliance, workforce challenges, and financial sustainability simultaneously—requires exceptional leadership and staff commitment. Our facilities' ability to maintain operations and serve vulnerable populations through extraordinary challenges including pandemic disruptions, workforce shortages, and regulatory changes demonstrates organizational resilience that should not be taken for granted.</p>

          <p>Our portfolio's rating distribution reflects genuine operational competency, with ${highPerformers} facilities (${((highPerformers/totalFacilities)*100).toFixed(0)}%) achieving 4-5 star ratings—above average performance that positions these facilities favorably for referrals, payer contracting, and community reputation. These high-performing facilities exemplify the quality care delivery that our organization strives to achieve across all facilities. Their success demonstrates that excellent outcomes are achievable within our operational model and resource constraints. The clinical leaders and staff at these facilities represent valuable internal expertise that can be leveraged for portfolio-wide improvement initiatives.</p>

          <p>Our organizational infrastructure provides capabilities that distinguish us from smaller operators. Regional clinical leadership enables expertise sharing, consistent policy implementation, and coordinated improvement initiatives that would be impossible for standalone facilities. Corporate quality improvement resources—including data analytics, training programs, compliance support, and technology systems—create sustainable advantages that compound over time as our analytical capabilities mature and our best practices accumulate. The investments we have made in professional development, compliance infrastructure, and operational systems position our facilities to succeed in an increasingly complex regulatory environment.</p>

          <p>The data systems exemplified by this detailed reporting capability enable evidence-based management that drives superior decision-making. Rather than relying on intuition or anecdote, our leaders can access comprehensive, current information about facility performance, identify specific improvement opportunities, and track intervention effectiveness. This analytical approach to operations management represents a genuine competitive advantage that supports continuous improvement across quality, efficiency, and financial performance dimensions.</p>
        </div>
  ...
  const generateComplianceReport = () => {
    ...
    return `
      ...
      <body>
        ...
        <h2>Immediate Compliance Recommendations</h2>
        <div class="narrative">
          <p>The regulatory compliance landscape for skilled nursing facilities demands immediate, decisive action to mitigate risk exposure and ensure continued certification status. Based on our portfolio analysis, several critical compliance priorities require immediate attention from operational and clinical leadership. First, all facilities must immediately implement enhanced infection prevention and control protocols in preparation for increased survey scrutiny. CMS has elevated infection control as a survey priority, and deficiencies in this area can result in immediate jeopardy citations with significant financial and operational consequences. Each facility should conduct immediate self-assessments against current infection control standards, verify staff competency in hand hygiene and PPE protocols, and ensure documentation systems capture all required infection surveillance data.</p>

          <p>Facilities identified as at-risk (1-2 star ratings) require immediate implementation of intensive compliance oversight programs. These facilities should receive weekly compliance reviews from regional leadership, daily clinical rounds documenting compliance with care planning requirements, and immediate remediation of any observed deficiencies before they can be cited during survey. The administrator and Director of Nursing at each at-risk facility must provide daily compliance status reports to regional leadership until ratings improve. Additionally, these facilities should immediately engage external survey preparation consultants to conduct comprehensive mock surveys identifying all potential areas of regulatory vulnerability.</p>

          <p>Staffing compliance represents an immediate priority given the approaching CMS minimum staffing rule implementation deadlines. All facilities must immediately assess their current staffing levels against the required thresholds: 3.48 total nursing hours per resident day and 0.55 registered nurse hours per resident day with 24/7 RN coverage. Facilities not currently meeting these standards must immediately develop and begin implementing staffing enhancement plans that will achieve compliance before applicable deadlines (May 2026 for urban facilities, May 2027 for rural facilities). Non-compliance will result in civil monetary penalties and potential certification actions that could jeopardize operations.</p>

          <p>Documentation compliance must be addressed immediately across all facilities. Accurate MDS submissions, proper PBJ data entry, and comprehensive care planning documentation directly impact both regulatory standing and quality ratings. Any facilities with identified documentation deficiencies must immediately implement corrective workflows and enhanced oversight to ensure data integrity.</p>
        </div>

        <h2>Long-Term Compliance Strategy</h2>
        <div class="narrative">
          <p>Sustainable regulatory compliance requires strategic investments in systems, processes, and organizational culture that extend well beyond immediate corrective actions. Our long-term compliance strategy must anticipate regulatory evolution while building organizational capabilities that ensure consistent, reliable compliance performance across all facilities. The regulatory environment for skilled nursing facilities continues to intensify, with enhanced survey processes, expanded enforcement authorities, and increased transparency requirements creating heightened compliance expectations that will only increase over time.</p>

          <p>We recommend establishing a dedicated corporate compliance function with authority and resources to implement portfolio-wide compliance programs. This function should include compliance officers at the regional level who can provide hands-on support to facilities while maintaining independence necessary for objective compliance assessment. Regular compliance audits—conducted at least quarterly at each facility—should assess performance against all major regulatory requirements and identify emerging risks before they manifest as survey deficiencies. The compliance function should maintain current awareness of regulatory developments and ensure timely communication of new requirements to operational leadership.</p>

          <p>Technology investments should support long-term compliance objectives. Automated compliance monitoring systems can track key regulatory indicators in real-time, alerting leadership to potential issues before they become serious deficiencies. Electronic documentation systems with built-in compliance checks can prevent documentation errors that create regulatory exposure. Analytics platforms that identify patterns and trends across facilities can enable proactive compliance management rather than reactive remediation. These technology investments typically yield returns through reduced deficiency citations, avoided penalties, and improved survey outcomes.</p>

          <p>Perhaps most importantly, our long-term strategy must cultivate a culture of compliance throughout the organization. Compliance cannot be delegated solely to designated compliance officers—every staff member must understand their role in maintaining regulatory standards. This requires ongoing training programs, clear accountability frameworks, and leadership modeling that demonstrates organizational commitment to compliance excellence. Facilities where compliance culture is embedded in daily operations consistently outperform those that treat compliance as a separate, periodic activity.</p>
        </div>

        <h2>Compliance Opportunities Identified</h2>
        <div class="narrative">
          <p>While regulatory compliance is often viewed primarily through a risk-mitigation lens, our portfolio analysis reveals several opportunities where compliance excellence can generate competitive advantages and operational benefits. The most significant opportunity involves leveraging our compliance capabilities to strengthen payer relationships and market positioning. As payers increasingly incorporate quality metrics and compliance history into contracting decisions, facilities with strong compliance records can negotiate favorable contract terms, secure preferred provider designations, and attract higher-acuity patients who generate improved reimbursement. Compliance excellence thus directly supports revenue enhancement objectives.</p>

          <p>The approaching CMS minimum staffing rule creates a unique competitive opportunity for operators who achieve early compliance. Many skilled nursing operators view the new staffing requirements as burdensome regulatory overreach and are seeking exemptions or delays. Organizations that proactively achieve compliance—and can demonstrate sustained compliance—will differentiate themselves in markets where competitors struggle. This first-mover advantage can manifest through improved recruitment success as nurses seek employers who maintain adequate staffing levels, enhanced referral relationships with discharge planners who prioritize well-staffed facilities, and favorable media coverage that strengthens community reputation.</p>

          <p>Compliance investments often yield operational improvements that extend beyond regulatory requirements. For example, enhanced infection control programs mandated by regulatory standards also reduce healthcare costs through prevented infections, improve resident outcomes that drive family satisfaction, and protect staff health that supports workforce retention. Similarly, staffing compliance investments improve care quality, reduce staff burnout, and enhance organizational reputation. Organizations that recognize these broader benefits can justify compliance investments more readily and implement them more enthusiastically than those viewing compliance solely as a cost center.</p>

          <p>Our compliance analytics capabilities create opportunities for predictive compliance management that can reduce deficiencies before surveys occur. By analyzing patterns in previous survey outcomes, quality measure trends, and operational indicators, we can identify facilities at elevated risk for adverse survey outcomes and deploy preventive interventions. This proactive approach to compliance management can substantially reduce deficiency citations, penalties, and associated remediation costs while improving ratings that drive revenue enhancement.</p>
        </div>

        <h2>Compliance Strengths Assessment</h2>
        <div class="narrative">
          <p>This compliance assessment appropriately focuses on risk identification and mitigation strategies, yet it is equally important to recognize the substantial compliance strengths within our portfolio that provide the foundation for sustained regulatory standing. Our organization has demonstrated consistent commitment to regulatory compliance through significant investments in compliance infrastructure, training programs, and oversight systems. These investments have yielded tangible results: our portfolio-wide compliance performance positions us favorably relative to industry benchmarks, and the majority of our facilities maintain satisfactory regulatory standing without significant enforcement actions.</p>

          <p>Our ${fiveStarCount + fourStarCount} facilities rated 4-5 stars demonstrate that excellent compliance outcomes are achievable within our operational model. These facilities have mastered the policies, procedures, and cultural elements that drive survey success, and their achievements demonstrate organizational capacity for compliance excellence. The leadership teams at these facilities represent valuable compliance expertise that can be leveraged for portfolio-wide improvement initiatives. Their proven approaches to survey preparation, staff training, and quality management should be documented and disseminated as best practices for adoption by lower-performing facilities.</p>

          <p>Our organizational infrastructure provides compliance capabilities that distinguish us from smaller operators who lack dedicated compliance resources. Regional clinical leadership enables expertise sharing and consistent policy implementation across facilities. Corporate compliance support—including regulatory monitoring, training program development, and survey preparation resources—creates sustainable advantages that would be impossible for standalone facilities to replicate. The investments we have made in compliance technology, documentation systems, and quality monitoring tools position our facilities to succeed in an increasingly complex regulatory environment.</p>

          <p>Our compliance reporting and analytics capabilities, exemplified by this assessment, enable evidence-based compliance management that supports superior outcomes. Rather than relying on reactive responses to survey deficiencies, our leaders can access current information about compliance risks, identify specific improvement priorities, and track intervention effectiveness. This analytical approach to compliance management represents a genuine competitive advantage that supports continuous improvement in regulatory standing. Our commitment to transparency in compliance assessment—acknowledging both strengths and areas requiring improvement—reflects organizational maturity that positions us well for sustained compliance success.</p>
        </div>
